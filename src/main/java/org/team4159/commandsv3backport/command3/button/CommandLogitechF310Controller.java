...
import org.team4159.commandsv3backport.driverstation.LogitechF310Controller;
...
public class CommandLogitechF310Controller {
    ...
    public CommandLogitechF310Controller(Scheduler scheduler, LogitechF310Controller controller) {
        m_controller = Objects.requireNonNull(controller, "Provided LogitechF310Controller cannot be null");
    ...
    public Trigger leftTrigger(double threshold, EventLoop loop) {
        return m_hid.axisGreaterThan(LogitechF310Controller.Axis.LEFT_TRIGGER.value, threshold, loop);
    }
    ...
    public Trigger rightTrigger(double threshold, EventLoop loop) {
        return m_hid.axisGreaterThan(LogitechF310Controller.Axis.RIGHT_TRIGGER.value, threshold, loop);
    }
