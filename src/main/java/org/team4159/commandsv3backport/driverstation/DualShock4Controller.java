...
public class DualShock4Controller implements HIDDevice, Sendable {
    ...
    private double m_L2Deadband = 0.01;
    private double m_R2Deadband = 0.01;
     ...
     */
    public DualShock4Controller(final int port) {
    ...
    public DualShock4Controller(final GenericHID hid) {
        ...
        HAL.report(tResourceType.kResourceType_Controller, hid.getPort(), 0, "DualShock4Controller");
    }
    ...
    public static EnumSet<GenericHID.SupportedOutput> getSupportedOutputCapabilities() {
        return EnumSet.of(GenericHID.SupportedOutput.RGB_LED, GenericHID.SupportedOutput.RUMBLE);
    }
     ...
     *
     * <p>A deadband of 0.01 is applied by default. Use {@link #setL2Deadband} to change it.
     *
     * @return The axis value.
     */
    public double getL2() {
        return MathUtil.applyDeadband(getAxis(Axis.L2), m_L2Deadband);
    }
     ...
     * @param deadband The deadband to apply.
     */
    public void setL2Deadband(double deadband) {
     ...
     *
     * <p>A deadband of 0.01 is applied by default. Use {@link #setR2Deadband} to change it.
     *
     * @return The axis value.
     */
    public double getR2() {
        return MathUtil.applyDeadband(getAxis(Axis.R2), m_R2Deadband);
    }
     ...
     * @param deadband The deadband to apply.
     */
    public void setR2Deadband(double deadband) {
    ...
    public BooleanEvent share(EventLoop loop) {
        return button(Button.SHARE, loop);
    }
