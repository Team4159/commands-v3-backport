...
class BooleanEventTest {
    ...
    void testBinaryCompositionLoopSemantics() {
        ...
        new BooleanEvent(loop1, bool1::get).and(new BooleanEvent(loop2, bool2::get)).ifHigh(counter1::incrementAndGet);

        new BooleanEvent(loop2, bool2::get).and(new BooleanEvent(loop1, bool1::get)).ifHigh(counter2::incrementAndGet);
        ...
        loop1.poll(); // 1st event executes, Bool 2 is true because loop 2 updated it, increments counter
