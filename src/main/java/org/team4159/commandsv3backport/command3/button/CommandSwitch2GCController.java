...
import org.team4159.commandsv3backport.driverstation.Switch2GCController;
...
public class CommandSwitch2GCController {
    ...
    public CommandSwitch2GCController(Scheduler scheduler, Switch2GCController controller) {
        m_controller = Objects.requireNonNull(controller, "Provided Switch2GCController cannot be null");
    ...
    public Trigger LTrigger(double threshold, EventLoop loop) {
        return m_hid.axisGreaterThan(Switch2GCController.Axis.L_TRIGGER.value, threshold, loop);
    }
    ...
    public Trigger RTrigger(double threshold, EventLoop loop) {
        return m_hid.axisGreaterThan(Switch2GCController.Axis.R_TRIGGER.value, threshold, loop);
    }
