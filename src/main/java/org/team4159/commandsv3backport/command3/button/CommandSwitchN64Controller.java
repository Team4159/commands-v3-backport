...
import org.team4159.commandsv3backport.driverstation.SwitchN64Controller;
...
public class CommandSwitchN64Controller {
    ...
    public CommandSwitchN64Controller(Scheduler scheduler, SwitchN64Controller controller) {
        m_controller = Objects.requireNonNull(controller, "Provided SwitchN64Controller cannot be null");
    ...
    public Trigger ZR(double threshold, EventLoop loop) {
        return m_hid.axisGreaterThan(SwitchN64Controller.Axis.ZR.value, threshold, loop);
    }
