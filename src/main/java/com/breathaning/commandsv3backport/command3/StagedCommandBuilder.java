...
public final class StagedCommandBuilder {
    ...
    private final NeedsExecutionBuilderStage m_needsExecutionView = new NeedsExecutionBuilderStage() {
        @Override
        ...
        public NeedsExecutionBuilderStage requiring(Collection<Mechanism> requirements) {
            ...
            for (Mechanism requirement : requirements) {
                requireNonNullParam(requirement, "requirements[" + i + "]", "StagedCommandBuilder.requiring");
                i++;
            }
    ...
    private final NeedsNameBuilderStage m_needsNameView = new NeedsNameBuilderStage() {
        @Override
        ...
        public Command named(String name) {
            ...
            if (m_endCondition == null) {
                ...
                m_builtCommand = new ParallelGroupBuilder().requiring(command).until(m_endCondition).named(m_name);
            }
