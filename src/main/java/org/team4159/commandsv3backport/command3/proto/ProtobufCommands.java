...
public final class ProtobufCommands {
    ...
    private static final RepeatedByte descriptorData = ProtoUtil.decodeBase64(
        2542,
    ...
    static final Descriptors.FileDescriptor descriptor = Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(
        "protobuf_commands.proto",
        "wpi.proto",
        descriptorData
    );

    static final Descriptors.Descriptor wpi_proto_ProtobufMechanism_descriptor = descriptor.internalContainedType(
        38,
        39,
        "ProtobufMechanism",
        "wpi.proto.ProtobufMechanism"
    );

    static final Descriptors.Descriptor wpi_proto_ProtobufCommand_descriptor = descriptor.internalContainedType(
        80,
        310,
        "ProtobufCommand",
        "wpi.proto.ProtobufCommand"
    );

    static final Descriptors.Descriptor wpi_proto_ProtobufScheduler_descriptor = descriptor.internalContainedType(
        393,
        193,
        "ProtobufScheduler",
        "wpi.proto.ProtobufScheduler"
    );
    ...
    public static final class ProtobufMechanism extends ProtoMessage<ProtobufMechanism> implements Cloneable {
        ...
        public boolean equals(Object o) {
            ...
            return bitField0_ == other.bitField0_ && (!hasName() || name.equals(other.name));
        }
        ...
        public static ProtobufMechanism parseFrom(final byte[] data) throws InvalidProtocolBufferException {
    ...
    public static final class ProtobufCommand extends ProtoMessage<ProtobufCommand> implements Cloneable {
         ...
         */
        private final RepeatedMessage<ProtobufMechanism> requirements = RepeatedMessage.newEmptyInstance(
            ProtobufMechanism.getFactory()
        );
    ...
    public static final class ProtobufScheduler extends ProtoMessage<ProtobufScheduler> implements Cloneable {
         ...
         */
        private final RepeatedMessage<ProtobufCommand> queuedCommands = RepeatedMessage.newEmptyInstance(
            ProtobufCommand.getFactory()
        );

        /**
         * <code>repeated .wpi.proto.ProtobufCommand running_commands = 2;</code>
         */
        private final RepeatedMessage<ProtobufCommand> runningCommands = RepeatedMessage.newEmptyInstance(
            ProtobufCommand.getFactory()
        );
        ...
        public static ProtobufScheduler parseFrom(final byte[] data) throws InvalidProtocolBufferException {
