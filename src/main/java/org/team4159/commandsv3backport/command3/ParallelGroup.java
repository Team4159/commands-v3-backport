...
public final class ParallelGroup implements Command {
     ...
     */
    ParallelGroup(String name, Collection<Command> requiredCommands, Collection<Command> optionalCommands) {
        ...
        m_priority = allCommands.stream().mapToInt(Command::priority).max().orElse(Command.DEFAULT_PRIORITY);
    }
