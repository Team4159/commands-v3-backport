...
import org.team4159.commandsv3backport.driverstation.DualSenseController;
...
public class CommandDualSenseController {
    ...
    public CommandDualSenseController(Scheduler scheduler, DualSenseController controller) {
        m_controller = Objects.requireNonNull(controller, "Provided DualSenseController cannot be null");
    ...
    public Trigger L2(double threshold, EventLoop loop) {
        return m_hid.axisGreaterThan(DualSenseController.Axis.L2.value, threshold, loop);
    }
    ...
    public Trigger R2(double threshold, EventLoop loop) {
        return m_hid.axisGreaterThan(DualSenseController.Axis.R2.value, threshold, loop);
    }
