...
import org.team4159.commandsv3backport.driverstation.DualSenseEdgeController;
...
public class CommandDualSenseEdgeController {
    ...
    public CommandDualSenseEdgeController(Scheduler scheduler, DualSenseEdgeController controller) {
        m_controller = Objects.requireNonNull(controller, "Provided DualSenseEdgeController cannot be null");
    ...
    public Trigger L2(double threshold, EventLoop loop) {
        return m_hid.axisGreaterThan(DualSenseEdgeController.Axis.L2.value, threshold, loop);
    }
    ...
    public Trigger R2(double threshold, EventLoop loop) {
        return m_hid.axisGreaterThan(DualSenseEdgeController.Axis.R2.value, threshold, loop);
    }
