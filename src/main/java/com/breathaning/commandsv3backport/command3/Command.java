...
public interface Command {
    ...
    default Command withTimeout(Time timeout) {
        ...
        return race(this, waitFor(timeout).named("Timeout: " + timeout.toLongString())).named(
            name() + " [" + timeout.toLongString() + " timeout]"
        );
    }
    ...
    default ParallelGroupBuilder until(BooleanSupplier endCondition) {
        ...
        return new ParallelGroupBuilder().optional(this, Command.waitUntil(endCondition).named("Until Condition"));
    }
