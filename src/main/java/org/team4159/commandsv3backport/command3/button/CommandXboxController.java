...
public class CommandXboxController {
    ...
    public CommandXboxController(Scheduler scheduler, XboxController controller) {
        m_controller = Objects.requireNonNull(controller, "Provided XboxController cannot be null");
    ...
    public Trigger leftTrigger(double threshold, EventLoop loop) {
        return m_hid.axisGreaterThan(XboxController.Axis.LEFT_TRIGGER.value, threshold, loop);
    }
    ...
    public Trigger rightTrigger(double threshold, EventLoop loop) {
        return m_hid.axisGreaterThan(XboxController.Axis.RIGHT_TRIGGER.value, threshold, loop);
    }
