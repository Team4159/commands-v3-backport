...
import org.team4159.commandsv3backport.driverstation.Switch2ProController;
...
public class CommandSwitch2ProController {
    ...
    public CommandSwitch2ProController(Scheduler scheduler, Switch2ProController controller) {
        m_controller = Objects.requireNonNull(controller, "Provided Switch2ProController cannot be null");
    ...
    public Trigger ZL(double threshold, EventLoop loop) {
        return m_hid.axisGreaterThan(Switch2ProController.Axis.ZL.value, threshold, loop);
    }
    ...
    public Trigger ZR(double threshold, EventLoop loop) {
        return m_hid.axisGreaterThan(Switch2ProController.Axis.ZR.value, threshold, loop);
    }
