...
import org.team4159.commandsv3backport.driverstation.DualShock4Controller;
...
public class CommandDualShock4Controller {
    ...
    public CommandDualShock4Controller(Scheduler scheduler, DualShock4Controller controller) {
        m_controller = Objects.requireNonNull(controller, "Provided DualShock4Controller cannot be null");
    ...
    public Trigger L2(double threshold, EventLoop loop) {
        return m_hid.axisGreaterThan(DualShock4Controller.Axis.L2.value, threshold, loop);
    }
    ...
    public Trigger R2(double threshold, EventLoop loop) {
        return m_hid.axisGreaterThan(DualShock4Controller.Axis.R2.value, threshold, loop);
    }
