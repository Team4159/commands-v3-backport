...
import org.team4159.commandsv3backport.driverstation.SwitchProController;
...
public class CommandSwitchProController {
    ...
    public CommandSwitchProController(Scheduler scheduler, SwitchProController controller) {
        m_controller = Objects.requireNonNull(controller, "Provided SwitchProController cannot be null");
    ...
    public Trigger ZL(double threshold, EventLoop loop) {
        return m_hid.axisGreaterThan(SwitchProController.Axis.ZL.value, threshold, loop);
    }
    ...
    public Trigger ZR(double threshold, EventLoop loop) {
        return m_hid.axisGreaterThan(SwitchProController.Axis.ZR.value, threshold, loop);
    }
