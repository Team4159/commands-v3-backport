...
import org.team4159.commandsv3backport.driverstation.GameCubeController;
...
public class CommandGameCubeController {
    ...
    public CommandGameCubeController(Scheduler scheduler, GameCubeController controller) {
        m_controller = Objects.requireNonNull(controller, "Provided GameCubeController cannot be null");
    ...
    public Trigger LTrigger(double threshold, EventLoop loop) {
        return m_hid.axisGreaterThan(GameCubeController.Axis.L_TRIGGER.value, threshold, loop);
    }
    ...
    public Trigger RTrigger(double threshold, EventLoop loop) {
        return m_hid.axisGreaterThan(GameCubeController.Axis.R_TRIGGER.value, threshold, loop);
    }
