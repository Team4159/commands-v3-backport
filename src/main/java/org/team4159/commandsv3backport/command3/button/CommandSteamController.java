...
import org.team4159.commandsv3backport.driverstation.SteamController;
...
public class CommandSteamController {
    ...
    public CommandSteamController(Scheduler scheduler, SteamController controller) {
        m_controller = Objects.requireNonNull(controller, "Provided SteamController cannot be null");
    ...
    public Trigger leftTrigger(double threshold, EventLoop loop) {
        return m_hid.axisGreaterThan(SteamController.Axis.LEFT_TRIGGER.value, threshold, loop);
    }
    ...
    public Trigger rightTrigger(double threshold, EventLoop loop) {
        return m_hid.axisGreaterThan(SteamController.Axis.RIGHT_TRIGGER.value, threshold, loop);
    }
