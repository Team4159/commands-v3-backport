...
public class SwitchProController implements HIDDevice, Sendable {
    ...
    public SwitchProController(final GenericHID hid) {
        ...
        HAL.report(tResourceType.kResourceType_Controller, hid.getPort(), 0, "SwitchProController");
    }
    ...
    public static EnumSet<GenericHID.SupportedOutput> getSupportedOutputCapabilities() {
        return EnumSet.of(GenericHID.SupportedOutput.MONO_LED, GenericHID.SupportedOutput.RUMBLE);
    }
